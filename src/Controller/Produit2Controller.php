...
class Produit2Controller extends Controller
{
     ...
     */
    public function search_rec(Request $request, NormalizerInterface $Normalizer, Produit2Repository $produit2Repository): Response
    {
        $requestString = $request->get('searchValue');
        $requestString3 = $request->get('orderid');

        $rec = $produit2Repository->findRec($requestString, $requestString3);
